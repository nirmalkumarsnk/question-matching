...
public class MatchDriver {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> fillerWords = new ArrayList<String>(Arrays.asList("a", "an", "the", "then", "there", "is",
				"it", "of", "are", "to", "some", "their", "by", "and", "that", "in", "but", "such", "as"));

		ArrayList<String> strArrQues = new ArrayList<String>();
		String strAns = "subgenus Hippotigris; the plains zebra, the Grevy's zebra and the mountain zebra;horses and donkeys;aims to breed zebras that are phenotypically similar to the quagga; Grevy's zebra and the mountain zebra";
		...
		try {
			...
			HashMap<String, String> matchResults = matchingAlgo.getResult();
